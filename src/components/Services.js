...
export function renderServices() {
    ...
    <div style="max-width:1080px; margin:0 auto; padding:0 24px;">
      ...
      ">
        ${services.items.map((item, i) => `
          <div class="service-card reveal${i > 0 ? ` reveal-delay-${i}` : ''}" style="
          ...
          ">
            <div style="
              ...
              background:${brand.color}; transform:scaleX(0);
            ...
            <div style="
              ...
              margin-bottom:10px; letter-spacing:-.01em; color:#1A1A1A;
            ">${item.name}</div>
            ...
            <span style="
              ...
              color:${brand.color}; background:${brand.colorLight};
  ...
  // Card hover: lift + reveal top bar
